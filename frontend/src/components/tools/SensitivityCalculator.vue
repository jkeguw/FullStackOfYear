        ...
        <el-form label-position="top">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <el-form-item label="计算结果">
              <div class="result-display py-2 px-3 bg-blue-900 rounded text-white text-lg font-bold text-center">
      ...
      <div class="card p-5 bg-gray-700 rounded-lg">
        ...
        <div v-else class="calibration-in-progress">
          ...
          <div class="action-buttons flex justify-between">
            ...
            <el-button v-if="currentPhase < 3" @click="nextPhase" size="small" type="info">跳过此阶段</el-button>
          </div>
        </div>
        ...
        <div v-if="currentPhase === 4" class="calibration-result mt-4 p-4 bg-blue-900 rounded-lg">
          ...
          <div class="text-center">
            <p class="mb-2">您的理想灵敏度: <span class="text-xl font-bold">{{ baseValue.toFixed(3) }}</span></p>
      ...
      <div class="card p-5 bg-gray-700 rounded-lg">
        ...
        <div v-else>
          ...
          <div v-if="bisectionStep > 9" class="calibration-result mt-4 p-4 bg-blue-900 rounded-lg">
            ...
            <div class="text-center">
              <p class="mb-2">您的理想灵敏度: <span class="text-xl font-bold">{{ bisectionBaseValue.toFixed(3) }}</span></p>
            </div>
          </div>
        </div>
      </div>
...
.result-display, .result-card {
  transition: all 0.3s ease;
}

.result-display:hover, .result-card:hover {
