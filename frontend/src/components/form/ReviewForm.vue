  ...
  <div class="review-form">
    ...
    >
        ...
        <div class="selected-device mb-6 p-4 bg-gray-50 rounded-md">
          <div class="flex">
            ...
            <div>
              ...
              <div v-if="selectedDevice.description" class="text-sm mt-2">
      ...
      <el-form-item label="使用场景" prop="usage">
        <el-select v-model="form.usage" placeholder="选择您的主要使用场景">
      ...
      <el-form-item label="优点" prop="pros">
        ...
        <el-button v-else size="small" @click="showProInput" class="mt-1"> + 添加优点 </el-button>
      </el-form-item>
      ...
      <el-form-item label="缺点" prop="cons">
        ...
        <el-button v-else size="small" @click="showConInput" class="mt-1"> + 添加缺点 </el-button>
      </el-form-item>
      ...
      <el-form-item label="详细评测" prop="content">
        ...
        <div class="mt-2 text-sm text-gray-500 flex justify-between items-center">
          ...
          <div>字数: {{ form.content.length }} / 最小要求: 50</div>
        </div>
      </el-form-item>
...
const rules = reactive<FormRules>({
  ...
  usage: [{ required: true, message: '请选择使用场景', trigger: 'change' }],
  score: [
    { required: true, message: '请进行评分', trigger: 'change' },
    { type: 'number', min: 1, message: '请至少给出1星评价', trigger: 'change' }
  ],
  pros: [{ type: 'array', min: 1, message: '请至少添加一个优点', trigger: 'change' }],
  cons: [{ type: 'array', min: 1, message: '请至少添加一个缺点', trigger: 'change' }],
  content: [
