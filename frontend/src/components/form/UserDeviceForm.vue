    ...
    >
      ...
      <el-form-item label="配置名称" prop="name">
        <el-input v-model="form.name" placeholder="输入设备配置名称">
          <template #prepend>
            <el-tooltip
              content="为您的配置起一个描述性的名称，如'FPS比赛设置'或'MOBA日常配置'"
              placement="top"
            >
      ...
      <el-form-item label="是否公开" prop="isPublic">
        ...
        <span class="ml-2 text-sm text-gray-500">
          <i
            :class="form.isPublic ? 'el-icon-view text-green-500' : 'el-icon-lock text-gray-500'"
            class="mr-1"
          ></i>
      ...
      <div
        ...
        class="empty-devices text-center py-8 bg-gray-50 rounded-lg"
      >
      ...
      <div
        v-else-if="form.devices.length === 1 && !form.devices[0].deviceId"
        class="guide-tip bg-yellow-50 p-4 rounded-md mb-4"
      >
        <div class="flex">
          <div class="flex-shrink-0">
      ...
      <div v-else class="devices-container">
        ...
        >
          <div
            class="device-header flex justify-between items-center mb-4 pb-2 border-b border-gray-200"
          >
              ...
              >
                ...
                >
                  <el-option label="鼠标" value="mouse">
                    <div class="flex items-center"><i class="el-icon-mouse mr-2"></i> 鼠标</div>
                  </el-option>
                  <el-option label="键盘" value="keyboard">
                    <div class="flex items-center"><i class="el-icon-platform mr-2"></i> 键盘</div>
                  </el-option>
                  <el-option label="显示器" value="monitor">
                    <div class="flex items-center"><i class="el-icon-monitor mr-2"></i> 显示器</div>
                  </el-option>
                  ...
                  <el-option label="配件" value="accessory">
                    <div class="flex items-center"><i class="el-icon-headset mr-2"></i> 配件</div>
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
          ...
          <div v-if="device.deviceId" class="mt-4 bg-white p-4 rounded-md">
            <div class="flex justify-between items-center mb-3">
              ...
              >
                ...
                <i
                  :class="[
                    device.showAdvancedSettings ? 'el-icon-arrow-up' : 'el-icon-arrow-down',
                    'ml-1'
                  ]"
                ></i>
              </el-button>
                ...
                <el-row :gutter="20">
                  <el-col :span="12">
                    <el-form-item label="颜色模式">
                      {/* @ts-ignore - Object member cannot be declared optional */}
...
// 监听设备类型变化
watch(
  () => form.devices.map((d) => d.deviceType),
  (newTypes) => {
    ...
    if (valid) {
      ...
      const data = {
        ...
        devices: form.devices.map((d) => ({
          ...
          // @ts-ignore - Missing properties on UserDeviceSetting
