  ...
  <div class="privacy-page container mx-auto py-8 px-4">
    ...
    <div class="bg-[#1E1E1E] rounded-lg p-6 mb-8 text-gray-300">
      ...
      <ul class="list-disc pl-6 mb-4 space-y-2">
        <li>账户信息：如您的姓名、电子邮件地址、密码和用户名。</li>
        <li>个人资料信息：如您的个人偏好、使用的设备和游戏设置。</li>
        <li>使用数据：如您如何使用我们的服务、访问的页面和功能。</li>
    ...
    <div class="bg-[#1E1E1E] rounded-lg p-6 mb-8 text-gray-300">
      ...
      <ul class="list-disc pl-6 mb-4 space-y-2">
        <li>经您同意或按您的指示。</li>
        <li>与我们的服务提供商和合作伙伴，以帮助我们提供服务。</li>
        <li>为遵守适用法律、法规或法律程序。</li>
    ...
    <div class="bg-[#1E1E1E] rounded-lg p-6 text-gray-300">
      ...
      <p>邮箱：privacy@mousecomparison.com</p>
    </div>
  </div>
</template>
