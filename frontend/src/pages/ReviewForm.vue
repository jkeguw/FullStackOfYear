            ...
            <el-form-item label="优点" prop="pros">
              <div class="flex items-center mb-2">
                <el-input 
                  ...
                  @keyup.enter="addPro"
                />
                <el-button @click="addPro" class="ml-2">
                  添加
                </el-button>
              </div>
            ...
            <el-form-item label="缺点" prop="cons">
              <div class="flex items-center mb-2">
                <el-input 
                  ...
                  @keyup.enter="addCon"
                />
                <el-button @click="addCon" class="ml-2">
                  添加
                </el-button>
              </div>
...
const rules = {
  ...
  score: [
    { required: true, type: 'number', message: '请设置评分', trigger: 'change' }
  ],
  usage: [
    { required: true, message: '请描述主要使用场景', trigger: 'blur' }
  ],
  content: [
