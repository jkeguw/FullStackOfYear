        ...
        <el-form label-position="top" class="text-white">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <el-form-item label="计算结果">
              <div class="result-display py-2 px-3 bg-[#2A2A2A] border border-[#444444] rounded text-white text-lg font-bold text-center">
