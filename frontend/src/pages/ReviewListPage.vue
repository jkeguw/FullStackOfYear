  ...
  <div class="review-list-page">
    <div class="container mx-auto p-4">
      <div class="flex justify-between items-center mb-4">
        ...
        <router-link to="/reviews/create" class="el-button el-button--primary" v-if="isAdmin">
      ...
      <el-card class="mb-4">
        <div class="flex flex-wrap gap-4 justify-between items-end">
          ...
          <div class="flex flex-wrap gap-2">
            <el-select v-model="filters.type" placeholder="评测类型" clearable @change="handleFilterChange">
      ...
      <div v-else-if="reviews.length === 0" class="text-center py-8">
        ...
        <router-link to="/reviews/create" class="el-button el-button--primary mt-4" v-if="isAdmin">
          创建第一篇评测
        </router-link>
      </div>
        ...
        >
          ...
          <div class="p-4">
            ...
            <div class="mt-4 flex gap-2">
              <el-button type="primary" @click="viewReview(review.id)">
                查看详情
              </el-button>
              <el-button plain @click="editReview(review.id)">
                编辑
              </el-button>
            </div>
          </div>
      ...
      <div class="flex justify-center mt-6" v-if="reviews.length > 0 && totalPages > 1">
        <el-pagination
...
const isAdmin = ref(true) // 假设用户是管理员，实际应从用户认证状态获取
