<template>
  <div class="device-detail-page">
    <div class="container mx-auto p-4">
      <el-page-header @back="router.back()" :title="'返回设备列表'" :content="device?.name || '设备详情'" />
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="md:col-span-1">
            <el-card class="h-full">
              ...
              <div class="mt-4 flex justify-center" v-if="hasAdminPermission">
              ...
              <div class="flex justify-between items-center">
                <div>
                  ...
                  <div class="mt-1 flex items-center">
                    ...
                    <span class="text-gray-500 ml-2">添加时间: {{ formatDate(device.createdAt) }}</span>
                  </div>
                </div>
              </div>
        ...
        <div class="mt-6">
          <el-card>
            ...
            <div v-if="reviews.length === 0 && !reviewsLoading" class="text-center py-8">
              ...
              <el-button class="mt-4" type="primary" @click="handleAddReview">成为第一个评测者</el-button>
            </div>
              ...
              <div v-loading="reviewsLoading">
                ...
                >
                  ...
                  <div v-if="canEditReview(review)" class="review-actions mt-4 flex justify-end">
                    ...
                    <el-button size="small" type="danger" @click="handleDeleteReview(review.id)">删除</el-button>
                  </div>
                </div>
